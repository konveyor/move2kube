...
// 2020-09-26 18:36:35.474947 +0530 IST m=+0.001220631
...
var Constants= map[string]string{
	...
	`kubernetes_yaml` : `apiVersion: move2kube.konveyor.openshift.io/v1alpha1
...
`,
	...
	`openshift_yaml` : `apiVersion: move2kube.konveyor.openshift.io/v1alpha1
kind: ClusterMetadata
metadata: 
  name: Openshift
spec:
